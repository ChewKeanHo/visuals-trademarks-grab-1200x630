# Grab's Trademarks Logo 1200x630 | (Holloway) Chew, Kean Ho's Visuals

[![logo](/share/icons/chewkeanho/trademarks/grab_1200x630.svg)](#)

The Grab's Trademark Logo. They published clear trademark guideline and
...
This project re-draws Grab's Trademarks Logo specifically for 1200x630 size.
...
4. While not specified by Grab; please ensures the outputs are web-ready.
   Refer:
...
> STILL OBLIGATED TO COMPLY WITH GRAB'S TRADEMARK REQUIREMENTS
> (refer: https://www.grab.com/sg/pressdownload)**.
>
...
```
Title: Grab's Trademark Logo 1200x630
Creators: Grab
