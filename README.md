# Grab Trademarks Logo 1200x630 | (Holloway) Chew, Kean Ho's Visuals

[![logo](/Pictures/banner_1200x630.svg)](#)

The Grab Trademarks Logo. They did not publish any trademark guideline but did
supply the material files for it. The preferred version is `.svg` which has
non-destructive scale up & down properties and can be converted into any
rasterized images (e.g. `jpeg`, `webp`, `avif`, etc). To comply with our
standards, a re-draw is required.

This project re-draws Grab Trademarks Logo specifically for 1200x630 size.
...
Since Grab did not publish any trademark guideline, **it is assumed standard
...
* https://www.grab.com/sg/pressdownload

While not specified by Grab, please ensure the outputs are also web ready.
Refer:
...
```
--------------------------------------------------------------------------------
Title: Grab Trademarks Logo 1200x630
Creators: (Holloway) Chew, Kean Ho
Contact: hello@chewkeanho.com
SKU: chewkeanho-visuals-trademarks-grab-1200x630
UUID: 7028B315-55B2-42D3-8E11-6E59A0F043EF
License: Creative Commons Attribution-NoDerivatives 4.0 International License
Made On: 2026-02-03
Made From: Malaysia, South East Asia
Procure: https://github.com/chewkeanho/visuals-trademarks-grab-1200x630
--------------------------------------------------------------------------------
```
...
> COMPLY WITH GRAB TRADEMARK REQUIREMENTS
> (Read: https://www.grab.com/sg/pressdownload)**.
>
